...
export default function Prospecta() {
  ...
  if (unlocked) {
    return (
      <iframe
        src="/prospecta-app.html"
        style={{ width: "100%", height: "100vh", border: "none", display: "block" }}
        title="Captação de Leads — MultiBrain"
      />
    );
  }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          MultiBrain <span style={{ color: "rgba(240,240,248,0.4)", fontWeight: 400 }}>·</span> Captação
        </div>
        <p style={{ color: "#7a7a9a", fontSize: "0.85rem", marginBottom: "2rem", margin: "0.25rem 0 2rem" }}>
